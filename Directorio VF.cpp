...
vector<DataName> DataCreation() {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        cout << "Ingrese el número de teléfono del contacto " << i + 1 << ": ";
        getline(cin, Info.Telefono[i]);
        cout << "Ingrese el nombre de la compañía del contacto " << i + 1 << ": ";
        getline(cin, Info.CorpInfo);
